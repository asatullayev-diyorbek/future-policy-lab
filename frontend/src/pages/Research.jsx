...
import { getAllResearch } from "../utils/researchApi"
...
export default function Research() {
  ...
  useEffect(() => {
    getAllResearch().then(setArticles)
  }, [])

  const filtered = useMemo(() => {
    if (activeTheme === "all") return articles
    return articles.filter((a) => a.theme === activeTheme)
  }, [activeTheme, articles])
